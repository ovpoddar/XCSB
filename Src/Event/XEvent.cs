...
public struct XEvent
{
    ...
    [FieldOffset(1)] public MotionEvent MotionEvent;

    [FieldOffset(1)] public EnterEvent EnterEvent;

    [FieldOffset(1)] public FocusEvent FocusEvent;

    [FieldOffset(1)] public KeymapEvent KeymapEvent;
    ...
    [FieldOffset(1)] public CirculateEvent CirculateEvent;
    ...
    [FieldOffset(1)] public GenericEvent GenericEvent;
}