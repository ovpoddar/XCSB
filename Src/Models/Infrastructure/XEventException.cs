...
{
    public XEventException(ErrorEvent errorEvent) 
        : base(GetErrorMessage(errorEvent.ErrorCode)) { }

    static string GetErrorMessage(ErrorCode errorCode) => errorCode switch
    {
        ErrorCode.Request => """
        ...
        ErrorCode.Pixmap => """
                            ...
                            """,
        ErrorCode.Atom => """
                            A value for an ATOM argument does not name a de-
                            fined ATOM.
                            """,
        ErrorCode.Cursor => """
                            ...
                            """,
        ErrorCode.Font => """
                            A value for a FONT argument does not name a de-
        ...
        ErrorCode.Drawable => """
                                ...
                                """,
        ErrorCode.Access => """
                            An attempt is made to grab a key/button combina-
        ...
        ErrorCode.Implementation => """
                                    The server does not implement some aspect of the re-
