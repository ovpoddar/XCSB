...
public class Depth
{
    ...
    internal static Depth Read(ISocketIn socketIn, ref int currentlyRead)
    {
        ...
        currentlyRead += SetVisual(result, socketIn);
        return result;
    }

    private static int SetVisual(Depth depth, ISocketIn socketIn)
    {
