...
public static class UncheckedDeclarationImplCode
{
    public static string GenerateInterfaceImplementation(INamedTypeSymbol interfaceSymbol)
    {
        ...
        sb.AppendLine("{");
        sb.AppendLine($"    public interface {interfaceSymbol.Name}Unchecked");
        sb.AppendLine("    {");
        foreach (var method in interfaceSymbol.GetMembers().OfType<IMethodSymbol>())
        {
            if (method.MethodKind != MethodKind.Ordinary) continue;
            sb.Append("       void ").Append(method.Name).Append("Unchecked");
