...
public static class AsyncDeclarationImplCode
{
    public static string GenerateInterfaceImplementation(INamedTypeSymbol symbol)
    {
        ...
        sb.AppendLine("{");
        sb.AppendLine($"    public interface {symbol.Name}Async");
        sb.AppendLine("    {");
        foreach (var method in symbol.GetMembers().OfType<IMethodSymbol>())
        {
            if (method.MethodKind != MethodKind.Ordinary) continue;
            sb.Append("       System.Threading.Tasks.Task<").Append(method.ReturnType).Append("> ").Append(method.Name).Append("Async");
